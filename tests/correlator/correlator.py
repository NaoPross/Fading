...
class correlator(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.epy_block_1 = epy_block_1.blk(vlen=frame_len)
        ...
        self.blocks_stream_mux_0 = blocks.stream_mux(gr.sizeof_char*1, [0, len(testvec), 4])
        self.blocks_repack_bits_bb_0 = blocks.repack_bits_bb(2, 8, "", True, gr.GR_MSB_FIRST)
