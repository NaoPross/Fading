...
class AM_Simulation_v2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "AM_Simulation_v2")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("AM_Simulation_v2")
        ...
        self.settings = Qt.QSettings("GNU Radio", "AM_Simulation_v2")
...
def main(top_block_cls=AM_Simulation_v2, options=None):
