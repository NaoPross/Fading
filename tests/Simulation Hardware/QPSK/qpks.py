...
class qpks(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.params.addTab(self.params_widget_0, '')
        ...
        self.uhd_usrp_source_0.set_center_freq(220e3, 0)
        ...
        self.blocks_vector_source_x_0 = blocks.vector_source_b((1, 0, 0), True, 1, [])
