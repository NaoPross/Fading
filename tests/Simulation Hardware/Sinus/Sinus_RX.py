...
class Sinus_RX(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Sinus_TX")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Sinus_TX")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Sinus_RX")
...
def main(top_block_cls=Sinus_RX, options=None):
