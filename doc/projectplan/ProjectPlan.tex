...
When the Prototype woks we integrate the fading channel models, including simulate and test them on the Hardware. 
At the end we do the same with a movable Reviser and compare the differences.
