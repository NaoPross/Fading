...
\begin{figure}
	\centering
	\input{figures/tikz/qpsk-sim-constellations-whitout-effects}
	\caption{
...
This number represent the sinusoids which are simulated for each ray, for that value 8 has been chosen.
